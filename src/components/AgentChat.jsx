    ...
    <div className="h-full flex flex-col bg-[#EFECE1]">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-2 space-y-5">
        <div className="flex items-start">
          ...
          <div className="bg-[#F5F3EC] border border-[#E0DCD1] px-4 py-3 rounded-2xl rounded-tl-sm text-[13.5px] text-[#3A3A3A] shadow-sm leading-relaxed">
            Hello! I am the PromptDuino agent. Describe what you'd like your Arduino to do, and I'll generate the code.
          </div>
        </div>

        <div className="flex items-start justify-end">
          <div className="bg-[#E0DCD1] px-4 py-3 rounded-2xl rounded-tr-sm text-[13.5px] text-[#3A3A3A] max-w-[80%] shadow-sm leading-relaxed">
      ...
      <div className="p-4 bg-[#EFECE1]">
        <div className="relative flex items-center shadow-sm rounded-xl bg-[#F5F3EC] border border-[#E0DCD1] focus-within:border-[#A3B0A3] focus-within:ring-2 focus-within:ring-[#A3B0A3]/20 transition-all">
          ...
          />
          <button className="absolute right-3 p-1.5 text-[#6392A8] hover:bg-[#EFECE1] rounded-lg transition-colors">
            <Send size={16} />
          </button>
        </div>
      </div>
